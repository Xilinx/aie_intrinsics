...
powershell (New-Object -ComObject Wscript.Shell).Popup("""Click OK to copy the help files to %UserProfile%\.Xilinx\Vitis\2021.1\helpdocs\aie_intrinsics\""",0,"""Accessing AI Engine Intrinsics Documentation""",0x0)
mkdir "%UserProfile%\.Xilinx\Vitis\2021.1\helpdocs\aie_intrinsics\
XCOPY /E/Y *.* "%UserProfile%\.Xilinx\Vitis\2021.1\helpdocs\aie_intrinsics\."
cd "%UserProfile%\.Xilinx\Vitis\2021.1\helpdocs\aie_intrinsics\."
DEL *.bat
DEL *.sh
